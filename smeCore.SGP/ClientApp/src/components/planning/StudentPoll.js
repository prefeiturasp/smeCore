    ...
    render() {
        return (
            <tr>
                ...
                <th>
                    <PollSelect sequence={this.props.student.sequence} name="t1l" value={this.props.student.pollResults.portuguese.t1l} updatePollStudent={this.props.updatePollStudent} />
                </th>
                <th>
                ...
                <th>
                    <PollSelect sequence={this.props.student.sequence} name="t2l" value={this.props.student.pollResults.portuguese.t2l} updatePollStudent={this.props.updatePollStudent} />
                </th>
                <th>
                ...
                <th>
                    <PollSelect sequence={this.props.student.sequence} name="t3l" value={this.props.student.pollResults.portuguese.t3l} updatePollStudent={this.props.updatePollStudent} />
                </th>
                <th>
                ...
                <th>
                    <PollSelect sequence={this.props.student.sequence} name="t4l" value={this.props.student.pollResults.portuguese.t4l} updatePollStudent={this.props.updatePollStudent} />
                </th>
            </tr>
        );
    }

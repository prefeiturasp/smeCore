...
export class CalendarDay extends Component {
  ...
  contentScheduleExists() {
    ...
    this.props.apiPost('api/Planejamento/ExisteConteudoAula', model)
      .then(data => {
        if (data.status === 200)
          ...
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-primary" data-dismiss="modal" onClick={this.contentScheduleExists}>Confirmar</button>
              </div>
            </div>
          </div>
        </div>
